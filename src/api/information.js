...
export function newsListByType (data, lang = 'zh-CN', newsArea = 1) {
...
export function newsListByTypeByPage (data, lang = 'zh-CN', newsArea = 1) {
    const baseURL = baseLangURL[newsArea][lang]
    return request({
...
export function canlendarListByDate (data, lang = 'zh-CN', newsArea = 1) {
    const baseURL = baseLangURL[newsArea][lang]
    return request({
...
export function articleDetail (data, lang = 'zh-CN', newsArea = 1) {
    const baseURL = baseLangURL[newsArea][lang]
    return request({
